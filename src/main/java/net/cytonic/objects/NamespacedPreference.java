 ...
 */
public record NamespacedPreference<T>(TypedNamespace<T> namespaceID, T value) {
     ...
     */
    public NamespacedPreference(TypedNamespace<T> namespaceID, Class<T> type, @Nullable T value) {
